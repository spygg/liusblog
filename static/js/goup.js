...
(function($){
 $.scrolltotop = function(options){
  options = jQuery.extend({
   ...
   controlHTML : '<a href="javascript:;"><img src="imgs/goto_top.png" style="border-radius: 8px; border-top-right-radius: 0;border-bottom-right-radius: 0;opacity: 0.8;background-color: #323d45;" alt="" /></a>',  //html代码
   className: '',     //样式名称
